...
class AsyncToSync:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # invmanager event loop's thread if it's there, otherwise make a new loop
        # in this thread.
        try:
...
class SyncToAsync:
    ...
    outermost), this will just be the invmanager thread. This is achieved by idling
    ...
    if "ASGI_THREADS" in os.environ:
        ...
        # be run at import time, and we want to update the invmanager thread's loop.
    ...
    # Storage for invmanager event loop references
