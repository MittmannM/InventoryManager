...
urlpatterns = [
    ...
    path('company/', include([
        ...
        path('employee_<name>', views_company.show_all_employees_by_name, name='show_single_employee_by_name'),
        path('employee/<uuid>', views_company.show_single_employee_by_uuid, name='show_single_employee_by_uuid'),
        path('employees_<machinery_uuid>', views_company.show_all_employees_by_machine, name='show_all_employees_by_machine'),
        ...
        path('machinery_<employee_uuid>/employees', views_company.show_all_machinery_by_employee, name='show_all_machinery_by_employee'),
